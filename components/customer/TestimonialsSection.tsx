              ...
              <div className="bg-warm-white/95 backdrop-blur-xl rounded-2xl sm:rounded-3xl p-6 sm:p-8 border border-parchment shadow-pottery-xl transition-all duration-300">
                ...
                <div className="flex items-center justify-between gap-2 mb-4 pb-4 border-b border-parchment/80">
                  <div className="flex items-center gap-2">
                    {/* Google 'G' Logo Badge */}
                    <div className="w-7 h-7 rounded-full bg-white shadow-xs border border-parchment flex items-center justify-center shrink-0">
                    ...
                    <span className="text-xs font-bold text-clay tracking-tight">Google Review</span>
                ...
                <div className="relative min-h-[130px] sm:min-h-[140px] flex items-center mb-5">
                  <Quote size={28} className="absolute -top-1 -left-1 text-terracotta/20 pointer-events-none" />
                  <p 
                    className={`text-clay text-sm sm:text-base leading-relaxed pl-5 transition-opacity duration-300 ${
                ...
                <div className="flex items-center justify-between pt-4 border-t border-parchment/80">
                  <div className="flex items-center gap-3">
                    <div className="w-10 h-10 rounded-full bg-clay text-warm-white font-bold flex items-center justify-center text-sm shadow-inner">
                      {current.name.charAt(0)}
                    </div>
                    <div>
                      <h4 className="font-playfair font-bold text-clay text-base leading-tight">
                        {current.name}
                      </h4>
                  ...
                  <div className="flex items-center gap-1.5">
                    <button
                      ...
                      className="w-8 h-8 rounded-full bg-cream hover:bg-parchment/80 text-clay flex items-center justify-center transition-colors shadow-xs"
                    >
                      <ChevronLeft size={16} />
                    </button>
                    <button
                ...
                <div className="flex items-center justify-center gap-1.5 mt-5 pt-3 border-t border-parchment/40">
